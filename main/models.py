...
class Offer(models.Model):
    ...
    salary_min = models.IntegerField(validators=[MinValueValidator(0), MaxValueValidator(10000)])
    salary_max = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(10000)])
    experience_min = models.IntegerField(validators=[MinValueValidator(0), MaxValueValidator(1000)])
